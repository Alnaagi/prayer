                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      "${prayerTimes.sunrise!.hour.toString()}:",
                                      style: const TextStyle(
                                          color: Colors.white,
                                          fontSize: 25,
                                          fontWeight: FontWeight.bold),
                                    ...
                                    AnimatedFlipCounter(
                                      value: prayerTimes.sunrise!.minute,
                                      // Use "infix" to show a value between negative sign and number
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.symmetric(horizontal: 15),
                              child: Text(
                                LocalData.sunrise.getString(context),
                                style: const TextStyle(
                                    color: Colors.black,
                                    fontSize: 25,
                                    fontWeight: FontWeight.bold),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      "${prayerTimes.dhuhrStartTime!.hour.toString()}:",
                                      style: const TextStyle(
                                          color: Colors.white,
                                          fontSize: 25,
                                          fontWeight: FontWeight.bold),
                                    ...
                                    AnimatedFlipCounter(
                                      value: prayerTimes.dhuhrStartTime!.minute,
                                      // Use "infix" to show a value between negative sign and number
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      "${prayerTimes.asrStartTime!.hour.toString()}:",
                                      style: const TextStyle(
                                          color: Colors.white,
                                          fontSize: 25,
                                          fontWeight: FontWeight.bold),
                                    ...
                                    AnimatedFlipCounter(
                                      value: prayerTimes.asrStartTime!.minute,
                                      // Use "infix" to show a value between negative sign and number
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      "${prayerTimes.maghribStartTime!.hour.toString()}:",
                                      style: const TextStyle(
                                          color: Colors.white,
                                          fontSize: 25,
                                          fontWeight: FontWeight.bold),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      "${prayerTimes.ishaStartTime!.hour.toString()}:",
                                      style: const TextStyle(
                                          color: Colors.white,
                                          fontSize: 25,
                                          fontWeight: FontWeight.bold),
                                    ...
                                    AnimatedFlipCounter(
                                      value: prayerTimes.ishaStartTime!.minute,
                                      // Use "infix" to show a value between negative sign and number
